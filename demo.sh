...
echo "3. Docker login: {\"method\":\"cloudru_containerapps_docker_login\",\"params\":{\"registry_name\":\"myregistry\",\"key_id\":\"mykeyid\",\"key_secret\":\"mykeysecret\"},\"id\":3}"
echo "4. Docker push: {\"method\":\"cloudru_containerapps_docker_push\",\"params\":{\"registry_name\":\"myregistry\",\"repository_name\":\"myrepo\",\"image_version\":\"v1.0.0\"},\"id\":4}"
echo ""
